...
class BookList: UIViewController, UITableViewDelegate, UITableViewDataSource {
    let contents:Dictionary<String, [String]> = ["A":["安其拉"],
                                                 "B":["步惊云","不知火舞","白起","扁鹊"],
                                                 "C":["程咬金","成吉思汗","蔡文姬","曹操"],
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "indexCellId")
        if cell==nil{
            cell = UITableViewCell(style: .default, reuseIdentifier: "indexCellId")
        }
